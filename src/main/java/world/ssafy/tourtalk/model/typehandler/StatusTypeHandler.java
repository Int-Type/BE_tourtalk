...
public class StatusTypeHandler extends BaseTypeHandler<MemberStatus>{

	// Java -> DB, enum을 DB에 저장, insert, update
	@Override
	public void setNonNullParameter(PreparedStatement ps, int i, MemberStatus parameter, JdbcType jdbcType)
			throws SQLException {
